...
use MobileNotify\Core\Services\Sender;
use Yii;
...
class SiteController extends Controller
{
    ...
    public function actionIndex()
    {
      ...
      if( $model->load(Yii::$app->request->post()) && $model->validate() ) {
        $smsClient = new SmsRuClient('7685F232-8764-3595-A8B2-C8692CAE04F6');
        $viberClient = new ViberClient('4f12d3e377e7dc96-7f35b72161ad27b9-32004a03a7fa4bff', 'test');
